        ...
        <section class="scrollable padder water-mark-visible-ff">
            ...
            <div class="row">
                <div class="col-md-6" style="margin-left: 35px;height: 100px;text-align: center;vertical-align: middle;background:rgb(74, 144, 226);border-radius: 15px;">
                    <label style="color:white;font-size:35px;font-family: PingFangSC-Semibold,sans-serif;width:100%;height: 100%;vertical-align: middle;margin-top: 4%;">调库</label>
                </div>
            </div>
...
<script src="/js/cutMarket/changeStore.js"></script>
