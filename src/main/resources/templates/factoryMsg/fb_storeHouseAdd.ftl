...
<#--<section class="panel panel-default">-->
    <div id="editPro" style="display: none;cursor:default">
        <div style="overflow-x: auto;overflow-y:auto;height: 250px;">
            ...
            <input type="text" hidden id="storehouseID">
            <table style="border-collapse:separate;border-spacing: 10px;width: 100%;">
                <tr>
                    ...
                    <td>
                        <input id="storehouseLocation" class="form-control" style="width: 100%;margin-bottom: 30px;border-top: none;border-right: none;border-left: none;">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="storehouseCount" class="form-control" style="width: 100%;border-top: none;border-right: none;border-left: none;" oninput = "value=value.replace(/[^\d]/g,'')"
