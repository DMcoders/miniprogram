    ...
    <section class="vbox">
        <section class="scrollable padder water-mark-visible-ff">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active">裁床报表</li>
            </ul>
            <div class="col-md-12" style="padding-top: 20px;">
                <section class="panel panel-default">
                    <div class="panel-body">
                        <div class="row" style="margin-bottom: 10px">
                            <div class="col-md-3" style="padding:0;text-align: right; margin-left: 50px;">
                                <span class="font-bold">订单号：</span>
                                <input id="orderName1" type="text" class="form-control" placeholder="请输入订单号" style="width:50%;">
                                <div id="orderNameTips" style="width: 60%;margin-left: 56px;"></div>
                            </div>
                            <div class="col-md-1" style="padding:0;">
                            </div>
                            <div class="col-md-3" style="padding:0;margin-left: 50px;">
                                <span class="font-bold">床号：</span>
                                <select id="bedNumber1" class="form-control" style="width: 50%;" placeholder="请选择床号">
                                </select>
                            </div>
                            <div class="col-md-1" style="padding:0;">
                            </div>
                        ...
                        <div style="text-align: center;font-family: PingFangSC-Semibold;">
                            <table id="cutReportTable" class="table table-striped table-hover">
                            </table>
                        </div>
                    </div>
                </section>
...
<script src="/js/orderMsg/cutReport.js?t=201905031623"></script>
