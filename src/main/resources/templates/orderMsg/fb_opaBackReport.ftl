                    ...
                    <section class="panel panel-default">
                        <div class="panel-body">
                            <div class="row" style="margin-bottom: 10px">
                                ...
                                <div class="col-md-3" style="padding:0">
                                    <button  class="btn" style="border-radius: 5px;color:white;font-family: PingFangSC-Semibold;width:60%;"  onclick="reportOpaBack()">花片回厂查询</button>
                                </div>
...
<#--<link rel="stylesheet" href="/css/bootstrap.min.css" type="text/css">-->
    ...
    <script src="/js/orderMsg/opaBackReport.js?t=201904211956"></script>
