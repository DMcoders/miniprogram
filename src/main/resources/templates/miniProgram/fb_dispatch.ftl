                    ...
                    <section class="panel panel-default">
                        <div class="panel-body" style="text-align: left">
                            <div class="row" style="margin-left: 0;margin-bottom: 0px">
                                <button  class="btn btn-s-lg" style="border-radius: 5px;color:white;font-family: PingFangSC-Semibold, sans-serif;"  onclick="addDispatch()">排产录入</button>
                            </div>
...
<script src="/js/miniProgram/dispatch.js?t=201904291638"></script>
